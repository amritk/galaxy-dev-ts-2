...
This is a generated TypeScript SDK for Demo API (Scalar Goolaxy), produced by the Scalar SDK Generator (https://scalar.com).
...
If the issue is in the Demo API (Scalar Goolaxy) or service rather than in this SDK, report it through the security process Demo API (Scalar Goolaxy) has published.
